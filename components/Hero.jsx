          ...
          <div className="text-left">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-12">
              ...
              <button
                ...
                className="px-8 py-4 text-green-400 font-medium text-lg hover:text-green-300 transition-colors focus:outline-none focus:ring-2 focus:ring-green-400/50 rounded-full"
              >
                How ClipSon Works →
              </button>
            </div>
